...
import org.assertstruct.AbstractMatchingTest;
...
public abstract class ListSharedTests extends AbstractMatchingTest {
    public ListSharedTests(AssertStructService env) {
        super(env);
    }
