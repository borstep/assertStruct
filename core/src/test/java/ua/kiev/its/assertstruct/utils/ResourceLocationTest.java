...
class ResourceLocationTest {
    ...
    void contentResourceLocationAt() {
        ...
        assertEquals("at ua.kiev.its.assertstruct.utils.ResourceLocationTest(ResourceLocationTest.java:10)", location.at());
...
//        System.out.println("at /C:/Boris/PRJ/pet/assertstruct-core/core/target/test-classes/res/res.txt (res.txt:0)");
    ...
    void contentResourceSrc() {
        ...
        uri = uri.replace('\\', '/');
        assertTrue(uri.contains("/core/src/test/java/ua/kiev/its/assertstruct/utils/ResourceLocationTest.java:"));
    }
}